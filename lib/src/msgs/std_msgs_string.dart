...
///  */
class std_msgs__msg__String extends ffi.Struct {
  external rosidl_runtime_c__String data;
}

/// An array of 8-bit characters terminated by a null byte.
class rosidl_runtime_c__String extends ffi.Struct {
